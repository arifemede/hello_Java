...
public class C01ArrayLists {
    ...
    // Short syntax to create a list and add elements into it
        ...
        // you can not use the ArrayList methods which change the number of elements in the list
        // for example: remove(), clear(), ad() can not be used
        // but set(), size() can be used
