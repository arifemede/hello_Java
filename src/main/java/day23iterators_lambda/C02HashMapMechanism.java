...
public class C02HashMapMechanism {
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            HashMap<String, Integer> hm = new HashMap<>(); // when you type this code java create a storage in a memory

            // The storage will have 16 boxes.
         ...
         // for each key, java create a unique hashcode

        // In the interview they may have ask the mechanism of HashMap.
