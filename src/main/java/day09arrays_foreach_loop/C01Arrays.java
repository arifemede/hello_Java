...
public class C01Arrays {
     ...
     */
            ...
            System.out.println(Arrays.toString(stdNames)); // Array names
            ...
            //1.Way:
            int result = 1;
            for(int i=0; i<ages.length; i++){  // we are starting from 0, bcz the index of first element is 0.
            ...
            for(int w : numbers){
                ...
                //maximum =  max(8, 8) -> 8
                //maximum =  max(8,12) -> 12
                //maximum=   max(12,34) -> 34   ==> compare 2 values and select the max value
