...
public enum UsStates {
         ...
         private final String stateName;  // to declare the data in enum is constant we type 'final'
         private final String abbreviation;
         private final String capitalCity;


         // to be able to use a data(variables) in enum I have to create a constructor;
         ...
         public String getStateName(){  // when I am outside the enum, I should be able to get statename. so  i make it public
             return stateName;
         }
