...
/*
  1) Java does not let us create an object from "abstract classes"
     ...
     "abstract methods" hav a missing part which is "method body"
  ...
  4) An "abstract classes" can have both "abstract methods" and "concrete methods"

     "concrete classes" can have just "concrete methods"

  5) "abstract methods" can use "public", "protected", and "default" access modifiers,
     "abstract methods" can not use "private" access modifiers

  6)  What is "final method?"
      "final method" is a method whose body cannot be updated.

  7)  Can we make an abstract method "final"?
      No. They do not have anybody that is why the body cannot be "final"

      Can we override a final method?
      No, because we change body in overriding but final methods do not accept any change on body.

  8)  Can we make an abstract method "static"? => (static means, it is shared by all the objects)
